...
pos_tool = casadi.Function('ptool', [cq],
                             [ cdata.oMf[idTool].translation - MsaneTarget.translation ])
rot_tool = casadi.Function('rtool', [cq],
                             [ log3_approx(cdata.oMf[idTool].rotation.T @ MsaneTarget.rotation) ])
dR =  casadi.Function('dR', [cq],
                             [ cdata.oMf[idTool].rotation.T @ MsaneTarget.rotation ])
